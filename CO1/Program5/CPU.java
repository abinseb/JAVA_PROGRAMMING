//Create CPU with attribute price.Create inner class processor(no.of cores,manufacturer) and static nexted class RAM (memory, manufacturer).Create an object of CPU and Print information of processor and RAM.
